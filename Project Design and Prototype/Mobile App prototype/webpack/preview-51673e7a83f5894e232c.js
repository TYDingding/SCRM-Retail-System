...
e%2?m(r,!0).forEach(function(e){(0,f.default)(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):m(r).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}var g={light:"plain",grey:"core",dark:"core"},y=h.default.createContext("light")
t.ThemeContext=y
t.withTheme=function(n){var r=function(e){function t(){return(0,l.default)(this,t),(0,s.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,c.default)(t,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,r=(0,o.default)(e,["forwardedRef"])
return h.default.createElement(y.Consumer,null,function(e){return h.default.createElement(n,v({ref:t,theme:g[e]},r))})}}]),t}(h.PureComponent)
return(0,f.default)(r,"propTypes",{forwardedRef:p.default.object}),h.default.forwardRef(function(e,t){return h.default.createElement(r,(0,i.default)({},e,{forwardedRef:t}))})}
var b=h.default.createContext()
t.TooltipContext=b
t.withTooltip=function(n){var r=function(e){function t(){return(0,l.default)(this,t),(0,s.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,c.default)(t,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,r=(0,o.default)(e,["forwardedRef"])
return h.default.createElement(b.Consumer,null,function(e){return h.default.createElement(n,v({ref:t,tipClassName:e},r))})}}]),t}(h.PureComponent)
return(0,f.default)(r,"propTypes",{forwardedRef:p.default.object}),h.default.forwardRef(function(e,t){return h.default.createElement(r,(0,i.default)({},e,{forwardedRef:t}))})}},"0uCA":function(e,t,r){"use strict"
var n=r("TqRt")
...
var n=r("SVae")
r("3ceZ")
t.requestThumbnail=function(e){return(0,n.requestThumbnailLocalhost)(e)}
t.requestSnapshot=function(e){return(0,n.requestSnapshotLocalhost)(e)}
t.requestSnapshotZip=function(e){return(0,n.requestSnapshotZipLocalhost)(e)}},"2b0G":function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var I=a(r("J4zp")),i=a(r("lwsE")),o=a(r("W8MJ")),l=a(r("a1gu")),c=a(r("Nsbk")),s=a(r("PJYZ")),u=a(r("7W2i")),d=a(r("lSNA")),f=a(r("17x9")),N=n(r("q1tI")),R=a(r("DKAG")),L=a(r("foKU")),D=a(r("tBsX")),A=r("oose"),B=a(r("dYO+")),F=a(r("DdUa")),q=a(r("kJQk")),U=a(r("9ZUU")),W=a(r("TSYQ"))
r("fSKh")
...
d=e.isColorPickerActive,f=e.isFullScreenMode,p=e.isLayerPreview,h=this.state.isDraggingCanvas,m=r.x,v=r.y,g="landscape"===a.orientation,y=s||u,b=y||!l?"none":c,S=n.width,w=n.height,E=g?[w,S]:[S,w],C=(0,I.default)(E,2),k=C[0],_=C[1],x={width:k,height:_,minWidth:k,minHeight:_,transform:"matrix(1, 0, 0, 1, ".concat(m,", ").concat(v,")")},T={transform:"scale(".concat(t/100,")")},P={width:"".concat(t,"%"),height:"".concat(t,"%")},O={width:a.width*t/100,height:a.height*t/100},M=(0,W.default)({"wait-drag":i||h,
"is-immersive":y,"is-layer-active":s,"is-screen-expanded":y||!l}),j=(0,W.default)("ui-layers",{"is-shadow":!("default"===b&&p),"is-active":s})
return N.default.createElement(L.default,{x:m,y:v,scale:t,id:"simulator-container",className:M,isDisabled:h,onMouseDown:this.handleMouseDown,onScaleChange:this.handleScaleChange,onOffsetChange:this.handleOffsetChange},function(e,t,r){return N.default.createElement("div",{key:"1",className:(0,W.default)("screen-viewport",{"is-fullscreen":f,"is-geely":"car_play"===n.model}),style:x},N.default.createElement("div",{className:"zoom-area",style:T},N.default.createElement(F.default,null),
!y&&N.default.createElement(B.default,{project:n,shellType:b,isLandscape:g}),o&&N.default.createElement(U.default,null)),N.default.createElement("div",{className:"no-zoom-area-wrapper",style:P},N.default.createElement("div",{className:"no-zoom-area",style:p&&l?{}:O},N.default.createElement("div",{id:"ui-layers",className:j},d&&N.default.createElement(q.default,null),s&&!d&&N.default.createElement(D.default,null)),N.default.createElement("div",{id:"ui-comment-marker-panel"},N.default.createElement(
...
return l.default.createElement(T,{className:t?"sub":""},l.default.createElement(M,null,l.default.createElement("img",{src:r,width:24,height:24}),l.default.createElement("div",null,a&&l.default.createElement("span",{className:"index"},"#".concat(a)),l.default.createElement("span",{className:"name"},n))),l.default.createElement(P,null,i&&l.default.createElement(j,{onSelect:i,menuClassName:"comment-header-edit",iconName:"cog",text:v.preview.comment.modify_edit}),o&&l.default.createElement(j,{onSelect:o,
...
var T=c.default.div.withConfig({displayName:"CommentLayerThreadContent__ContentHeaderDiv",componentId:"sc-1lkzl71-7"})(["display:flex;justify-content:space-between;padding-bottom:10px;width:100%;&.sub{padding:10px;}"]),P=c.default.div.withConfig({displayName:"CommentLayerThreadContent__ContentHeaderEditDiv",componentId:"sc-1lkzl71-8"})(["display:flex;align-items:center;.icon{color:#c8cdd0;margin-left:5px;&:hover,&:active{color:#8d9ea7;}}"]),O=(0,c.createGlobalStyle)(m())
t.CommentHeaderGlobalStyle=O
...
j.propTypes={onSelect:o.default.func.isRequired,text:o.default.string.isRequired,iconName:o.default.string.isRequired,menuClassName:o.default.string.isRequired}},7:function(e,t,r){r("j36g"),r("LSZE"),r("ls82"),e.exports=r("Z3xQ")},"7Rdd":function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
A.cancel=Y.u
var x,T,P,O,M,j,I,N=(x=h,T=m,O=v,(P=n)._deferredEnd=null,(j={})[Y.e]=!0,j.id=x,j.name=T,(I={})[M="done"]=I[M]||{},I[M].get=function(){if(P._deferredEnd)return P._deferredEnd.promise
var e=Object(Y.l)()
return P._deferredEnd=e,P._isRunning||(P._error?e.reject(P._error):e.resolve(P._result)),e.promise},j.cont=O,j.joiners=[],j.cancel=D,j.isRunning=function(){return P._isRunning},j.isCancelled=function(){return P._isCancelled},j.isAborted=function(){return P._isAborted},j.result=function(){return P._result},j.error=function(){return P._error},j.setContext=function(e){Object(Y.h)(e,Y.q.object,Object(Y.k)("task",e)),Y.v.assign(_,e)},function(e,t){for(var r in t){var n=t[r]
n.configurable=n.enumerable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,r,n)}}(j,I),j),R={name:m,cancel:function(){R.isRunning&&!R.isCancelled&&(R.isCancelled=!0,A(Q))},isRunning:!0},L=function(e,n,a){var i=[],o=void 0,l=!1
...
function D(){n._isRunning&&!n._isCancelled&&(n._isCancelled=!0,L.cancelAll(),B(Q))}return v&&(v.cancel=D),n._isRunning=!0,A(),N
...
o?r(c):l._isRunning?(L.addTask(c),r(c)):l._error?L.abort(l._error):r(c)}finally{Object(X.b)()}}function H(n,t,a){var i=Object.keys(n)
...
break
case 6:return e.next=8,t=n.artboard_id,(0,c.requestJSON)("".concat("/api/v2/sketch","/artboards/").concat(t,".json"))
case 8:o=e.sent
...
var P=function(e){switch(e.type){case C:return p.default.createElement(O,{link:e})
case k:return p.default.createElement(M,{link:e})
case _:return p.default.createElement(j,{link:e})
case x:return p.default.createElement(I,{link:e})
default:return null}},O=function(e){function t(){return(0,i.default)(this,t),(0,l.default)(this,(0,c.default)(t).apply(this,arguments))}return(0,u.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=this.props.link,t=[]
...
optionList:v.TRANSITIONS,onChange:this.handleLinkTarget})))}}]),t}(p.PureComponent),M=function(e){function t(){return(0,i.default)(this,t),(0,l.default)(this,(0,c.default)(t).apply(this,arguments))}return(0,u.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=this.props.link,t=[{cid:"default",name:"默认状态"}]
...
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var c=a(r("o0o1")),i=a(r("yXPU")),o=a(r("lwsE")),l=a(r("W8MJ")),s=a(r("a1gu")),u=a(r("Nsbk")),d=a(r("PJYZ")),f=a(r("7W2i")),p=a(r("lSNA")),m=n(r("q1tI")),h=a(r("17x9")),v=r("DqDi"),g=r("i6OX"),y=a(r("4QcC")),b=a(r("Ur7v")),S=a(r("lCKy")),w=a(r("iX79")),E=r("/5+U"),C=r("1iCU"),k=r("t3Un"),_=r("2EV6"),x=r("Gbs1"),T=r("6x+O"),P=a(r("rtgd")),O=a(r("UbMB")).default.bind(P.default),M=[{label:I18N.preview.preview,icon:m.default.createElement(g.SVGIcon,{name:"design/preview"})},{
label:I18N.preview_panel.developer_mode,icon:m.default.createElement(g.SVGIcon,{name:"design/inspect"})},{label:I18N.preview_panel.comment,icon:m.default.createElement(g.SVGIcon,{name:"design/comment"})}],j=M.slice(0,2),I=function(e){function i(){var e,n;(0,o.default)(this,i)
for(var t=arguments.length,r=new Array(t),a=0;a<t;a++)r[a]=arguments[a]
...
return p.default.createElement("div",{key:e.cid,"data-cid":e.cid,"data-link_cid":n,id:"widget".concat(e.cid,"p"),className:t,style:r,onClick:this.handleClick},(0,h.getWidgetContent)(e))}}]),i}(p.PureComponent);(0,f.default)(g,"propTypes",{sticky:i.default.object})},I19b:function(e,t,r){},IV71:function(e,t,r){"use strict"
var n=r("TqRt")
...
t.default=v,(0,d.default)(v,"propTypes",{activeCid:p.default.string,screenTreeMap:p.default.object,screenDataMap:p.default.object,renderCommentIcon:p.default.func,dispatch:p.default.func})},MzIM:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=n(r("pVnL")),o=n(r("QILm")),l=n(r("lwsE")),c=n(r("W8MJ")),s=n(r("a1gu")),u=n(r("Nsbk")),d=n(r("PJYZ")),f=n(r("7W2i")),p=n(r("lSNA")),h=n(r("q1tI")),i=n(r("17x9")),m=r("6XO9"),v=function(e){function i(){var e,t;(0,l.default)(this,i)
for(var r=arguments.length,n=new Array(r),a=0;a<r;a++)n[a]=arguments[a]
return t=(0,s.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(t),"handleChange",function(e){return t.props.onChange(e,t.props.attr)}),t}return(0,f.default)(i,e),(0,c.default)(i,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,r=(e.attr,e.size),n=(e.onChange,(0,o.default)(e,["forwardedRef","attr","size","onChange"]))
return h.default.createElement(m.Select,(0,a.default)({},n,{ref:t,size:r,onChange:this.handleChange}))}}]),i}(h.default.PureComponent);(0,p.default)(v,"propTypes",{forwardedRef:i.default.object,attr:i.default.string,size:i.default.oneOf(["regular","small"]),onChange:i.default.func}),(0,p.default)(v,"defaultProps",{size:"small"})
var g=h.default.forwardRef(function(e,t){return h.default.createElement(v,(0,a.default)({forwardedRef:t},e))})
t.default=g},NcbO:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.fetchSliceZip=function(e){return(0,n.requestJSON)("".concat("/api/v2","/sketch/slices/build_zip.json?project_cid=").concat(e),null,{method:"POST"})}},NyBV:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
...
return{length:o?Math.round(l):l,angle:o?Math.round(u)%360:u,thickness:c}}var O=n(r("J4zp"))
t.getLineGeneralInfo=_
var d=function(e,t,r){var n=(0,O.default)(r,2),a=n[0],i=n[1],o=(i[0]-a[0])*e,l=(i[1]-a[1])*t
return c(o,l)}
t.getLineAngle=d
...
t.degreeToRadians=x
function M(e,t){var r=(0,O.default)(e,2),n=r[0],a=r[1],i=x(t)
return[Math.cos(i)*n+Math.sin(i)*a,-Math.sin(i)*n+Math.cos(i)*a]}t.getVectorInOtherSystem=M
t.getLineAttrsAfterUngroup=function(e,t,r,n){var a=(0,O.default)(e,2),i=a[0],o=a[1],l=(0,O.default)(t,2),c=l[0],s=l[1],u=n.top,d=n.left,f=n.width,p=n.height,h=n.points,m=JSON.parse(h).map(function(e){return e.point}),v=(0,O.default)(m,2),g=(0,O.default)(v[0],2),y=g[0],b=g[1],S=(0,O.default)(v[1],2),w=S[0],E=S[1],C=[d-c,u-s],k=[C[0]+w*f,C[1]+E*p],_=M([C[0]+y*f,C[1]+b*p],-r),x=M(k,-r),T=[i+_[0],o+_[1]],P=[i+x[0],o+x[1]]
return j(T,P)}
var j=function(e,t){var r=(0,O.default)(e,2),n=r[0],a=r[1],i=(0,O.default)(t,2),o=i[0],l=i[1],c=Math.min(a,l),s=Math.min(n,o),u=Math.abs(o-n),d=Math.abs(l-a),f=[[0===u?.5:(n-s)/u,0===d?.5:(a-c)/d],[0===u?.5:(o-s)/u,0===d?.5:(l-c)/d]].map(function(e){return{point:e}})
...
t.getLineAttrsAfterRotate=function(e,t,r){var n=2<arguments.length&&void 0!==r?r:0,a=x(t),i=e.top,o=e.left,l=e.width,c=e.height,s=e.points,u=JSON.parse(s).map(function(e){return e.point}),d=(0,O.default)(u,2),f=(0,O.default)(d[0],2),p=f[0],h=f[1],m=(0,O.default)(d[1],2),v=m[0],g=m[1],y=_(e).length,b=[o+l*p,i+c*h],S=[o+l*v,i+c*g],w=[b[0]+(S[0]-b[0])*n,b[1]+(S[1]-b[1])*n],E=[b[0]+y*Math.cos(a),b[1]+y*Math.sin(a)],C=[b[0]+(E[0]-b[0])*n,b[1]+(E[1]-b[1])*n],k=[w[0]-C[0],w[1]-C[1]]
return j([b[0]+k[0],b[1]+k[1]],[E[0]+k[0],E[1]+k[1]])}
t.lineIsParallelWithAxis=function(e){var t=(0,O.default)(e,2),r=(0,O.default)(t[0],2),n=r[0],a=r[1],i=(0,O.default)(t[1],2),o=i[0],l=i[1]
...
return h.default.createElement(O,{key:"".concat(t).concat(e),canDel:l,trackId:a,handleDelColor:o,color:n,rgbaColor:r,colorUnit:c,focusColor:s})}):h.default.createElement(M,null)))}
...
return{userPickColor:t.userPickColor,focusColor:t.focusColor}})(x),P=function(e,t,r){return(0,S.getColorFromUnit)(e?(0,S.parseSketchColor2rgba)(t):t,r)},O=function(e){var t=e.color,r=e.rgbaColor,n=e.colorUnit,a=e.handleDelColor,i=e.canDel,o=e.trackId,l=e.focusColor,c=t===(0,S.getColorFromUnit)(l,n)
...
O.propTypes={color:m.default.string.isRequired,trackId:m.default.string,handleDelColor:m.default.func,colorUnit:m.default.string,rgbaColor:m.default.string,canDel:m.default.bool,focusColor:m.default.string}
var M=function(){return h.default.createElement("div",{className:"forbid-color"},h.default.createElement("div",{className:"transparent"}))},j=function(e){function i(){var e,n;(0,l.default)(this,i)
for(var t=arguments.length,r=new Array(t),a=0;a<t;a++)r[a]=arguments[a]
...
var n=r("Iusu"),a=r("Ij3M"),i=r("wQP3"),o=r("LVRM"),l=r("QlAn"),c=r("bekf"),s=r("1Uxz"),u=r("h9XN"),d=r("WyLE")},Rm7n:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=n(r("pVnL")),o=n(r("QILm")),l=n(r("lwsE")),c=n(r("W8MJ")),s=n(r("a1gu")),u=n(r("Nsbk")),d=n(r("PJYZ")),f=n(r("7W2i")),p=n(r("lSNA")),h=n(r("q1tI")),i=n(r("17x9")),m=r("6XO9"),v=function(e){function i(){var e,n;(0,l.default)(this,i)
for(var t=arguments.length,r=new Array(t),a=0;a<t;a++)r[a]=arguments[a]
return n=(0,s.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(r))),(0,p.default)((0,d.default)(n),"handleChange",function(e,t,r){return n.props.onChange(r,n.props.attr)}),n}return(0,f.default)(i,e),(0,c.default)(i,[{key:"render",value:function(){var e=this.props,t=(e.attr,e.size),r=(e.onChange,(0,o.default)(e,["attr","size","onChange"]))
return h.default.createElement(m.Check,(0,a.default)({},r,{size:t,onChange:this.handleChange}))}}]),i}(h.default.PureComponent);(t.default=v).propTypes={attr:i.default.string,size:i.default.oneOf(["regular","small"]),onChange:i.default.func},v.defaultProps={size:"small"}},Ro3d:function(e,t,r){"use strict"
var n=r("TqRt")
...
,F(l,n,a)),x=c&&(0,A.default)({},q[a].opacity,F(c,n,a)),T=s&&(0,A.default)({},q[a].borderRadius,F(s,n,a)),P=f&&(0,A.default)({},q[a].backgroundColor,F(f,n,a,!0)),O=p&&(0,A.default)({},q[a].color,F(p,n,a,!0)),M=h&&(0,A.default)({},q[a].fontSize,F(h,n,a)),j=m&&(0,A.default)({},q[a].fontFamily,F(m,n,a)),I=v&&(0,A.default)({},q[a].fontStyle,F(v,n,a)),N=g&&(0,A.default)({},q[a].shadows,g),R=u&&(0,A.default)({},q[a].borderWidth,F(u,n,a)),L=d&&(0,A.default)({},q[a].borderColor,F(d,n,a,!0)),D=y&&(0,A.default)({},
q[a].textAlign,y)
return Object.assign({},w,E,C,k,_,x,T,R,L,P,O,M,I,D,N,j)}
...
var n=r("t3Un")
t.fetchArtboardsByProjectCid=function(e){return window.MBArtboards?{artboards:Object.values(window.MBArtboards).map(function(e){return e.artboard})}:(0,n.requestJSON)("".concat("/api/v2/sketch","/artboards.json?project_cid=").concat(e))}},S9rr:function(e,t,r){"use strict"
var n=r("TqRt")
...
case 15:case"end":return e.stop()}},e)}))
return function(e){return t.apply(this,arguments)}}()
t.requestSnapshotZipLocalhost=i},Sxd8:function(e,t){e.exports=function(e){return e}},TT1N:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.FormEntry=o,t.FormLabel=function(e){return l.default.createElement(o,(0,a.default)({},e,{isLabel:!0}))}
var a=n(r("pVnL")),l=n(r("q1tI")),i=n(r("17x9"))
function o(e){var t=e.className,r=e.name,n=e.children,a=e.type,i=e.isLabel,o=e.isRequired
return l.default.createElement(i?"label":"div",{className:"form-entry ".concat(t),type:a},r&&l.default.createElement("span",{className:"key"},r,o&&l.default.createElement("span",{className:"required-sign"},"*")),l.default.createElement("span",{className:"val"},n))}r("qY2g"),o.propTypes={className:i.default.string,children:i.default.any,name:i.default.any,type:i.default.string,isLabel:i.default.bool,isRequired:i.default.bool},o.defaultProps={className:"",isLabel:!1}},TZdj:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function n(i,o){return s(function(e,t,r){var n=t.dispatch,a=r&&r.payload
...
e%2?T(r,!0).forEach(function(e){(0,h.default)(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):T(r).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}var O=function(e){function t(){var r
...
return!MB.isDashboard&&g.default.createElement(x.default,(0,i.default)({isOpen:e,onToggle:this.onToggleSharingOverlay,updateTeamFromProps:this.updateTeam,updateAppFromProps:this.updateApp},t,{withStore:!1}))}}]),t}(g.PureComponent);(0,h.default)(O,"propTypes",{checkPermissionStorelessly:y.default.func})
var M=(0,b.connect)(void 0,{checkPermissionStorelessly:k.checkPermissionStorelessly})(O)
t.default=M},"Uu/L":function(e,t,r){"use strict"
var n=r("TqRt")
...
return function(e,t){return r.apply(this,arguments)}}()
t.onFallbackError=h},VkAN:function(e,t){e.exports=function(e,t){return t=t||e.slice(0),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}},WcC0:function(e,t,r){},WyLE:function(e,t,r){"use strict"
var n=r("TqRt")
...
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=a(r("PJYZ")),o=a(r("lSNA")),l=a(r("lwsE")),c=a(r("W8MJ")),s=a(r("a1gu")),u=a(r("Nsbk")),d=a(r("7W2i")),y=n(r("q1tI")),f=a(r("17x9")),p=r("vOnD"),h=a(r("i6OX")),b=r("wYtL"),m=a(r("QdB0")),S=a(r("5Mi5")),w=a(r("ULaQ")),E=a(r("Aa0X")),C=a(r("18l9")),k=a(r("jZq5")),_=a(r("DJvY")),x=a(r("DdUa")),T=a(r("2AqR")),P=a(r("nQhf")),O=a(r("xUDz")),M=a(r("NyBV")),j=a(r("ewu5")),I=a(r("mdx/")),v=a(r("gY5R")),N=r("1iCU"),g=a(r("XpKX")),R=a(r("UbMB")),L=r("/5+U");(0,r("aYxX").initI18n)(window.MBLocale)
var D=R.default.bind(g.default),A=window,B=A.MB,F=A.I18N,q=new Set(["ai@mockingbot.com","ethantw@me.com"]),U=function(e){function t(){return(0,l.default)(this,t),(0,s.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,c.default)(t,[{key:"render",value:function(){return y.default.createElement(p.ThemeProvider,{theme:v.default.light},y.default.createElement(W,this.props))}}]),t}(y.PureComponent)
t.default=U
...
this.props.dispatch({type:"event-sign-up:set:event",payload:t})}(0,L.canBackToWorkspace)()||B.event("zhuge","PreviewOrLinkPreview_enter",{User_id:"",ProjectCreator_id:B.currentProject.owner_id,via:"click",IF_User_ProjectCreator:!1,From:"Link"})}},{key:"render",value:function(){var e=this.props,t=e.isLite,r=e.project,n=e.previewSetting,a=e.isProjectFromOtherFreeUser,i=e.toastList,o=e.popupList,l=e.dispatch,c=this.state.showLoadtip
...
var s=r.owner_email,u=r.master,d=n.toolbarActiveItem,f=n.isFullScreenMode,p=d==N.PREVIEW,h=d==N.INSPECT,m=!B.isElectron()&&!B.isHTMLZip()&&h&&c&&z(),v=!u&&p&&(q.has(s)||a),g=D("mb-preview-page",{"is-offline-mode":B.isHTMLZip(),"is-uichina":B.isUIChina()||B.isForum(),"full-screen":f})
return y.default.createElement("div",{className:g},y.default.createElement(T.default,null),f&&y.default.createElement(O.default,null),y.default.createElement("div",{id:"preview-content-container",className:"preview-content-container"},y.default.createElement(E.default,null),y.default.createElement(_.default,null),y.default.createElement(k.default,null),y.default.createElement(C.default,null)),v||B.isUIChina()&&y.default.createElement("a",{className:"powered-by",href:"/",target:"_blank"},
y.default.createElement("img",{className:"zh",src:"/images/preview/watermark_zh.svg",alt:F.preview.powered_by_modao}),y.default.createElement("img",{className:"en",src:"/images/preview/watermark_en.svg",alt:F.preview.powered_by_modao})),y.default.createElement(H,{isActive:m,onClick:this.handleClick}),p&&y.default.createElement(M.default,null),y.default.createElement(P.default,null),y.default.createElement(w.default,null),y.default.createElement(S.default,{dispatch:l}),y.default.createElement(
...
var c=a(r("o0o1")),i=a(r("yXPU")),l=a(r("lwsE")),o=a(r("W8MJ")),s=a(r("a1gu")),u=a(r("Nsbk")),d=a(r("PJYZ")),f=a(r("7W2i")),p=a(r("lSNA")),h=a(r("17x9")),m=n(r("q1tI")),v=r("/MKj"),g=a(r("sEfC")),y=r("wYtL"),b=a(r("i6OX")),S=r("rbsZ"),w=a(r("prTy")),E=a(r("UbMB")),C=a(r("2s0x")),k=r("/5+U"),_=r("Nu6V"),x=r("upRB"),T=E.default.bind(C.default),P=!1,O=function(e){function a(e){var o;(0,l.default)(this,a),o=(0,s.default)(this,(0,u.default)(a).call(this,e)),(0,p.default)((0,d.default)(o),"handleActiveLayer",
function(e){o.setState({activeLayerId:e})}),(0,p.default)((0,d.default)(o),"downloadSlice",(0,i.default)(c.default.mark(function e(){var t,r,n,a,i
return c.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(t=o.props,r=t.projectCid,n=t.projectName,a=t.isLogin,MB&&MB.currentProject&&!MB.currentProject.limitation.inspectable)return(0,S.openRenewModal)("inspectable"),e.abrupt("return")
e.next=4
break
case 4:if(!0!==o.state.download&&a){e.next=6
break}return e.abrupt("return")
case 6:return o.startLoadSlice(),e.next=9,D(r,n)
...
t({type:"REQUEST_SELECT_LAYER",payload:{layerID:e}}),t({type:"reducer:preview-toolbar:update",payload:{isSelectLayer:!0}})}),P=!1,o.state={download:!1,activeLayerId:null}
var t=o.props,r=t.loading,n=t.dispatch
return r&&n({type:"reducer:slice:init"}),o}return(0,f.default)(a,e),(0,o.default)(a,[{key:"componentWillUnmount",value:function(){var e=this.props,t=e.projectCid,r=e.dispatch,n=this.state.download,a="/api/v2/projects/".concat(t,"/build/slices_zips.json")
n&&(P=!0,r({type:"reducer:preview-toolbar:update",payload:{loadSliceUrl:a}}))}},{key:"render",value:function(){var o=this,e=this.state,t=e.download,l=e.activeLayerId,r=this.props,n=r.slicesMap,a=r.loading,i=r.error,c=r.currentArtboardId,s=r.isLogin
return i||a?m.default.createElement(R,null):0===n.length?m.default.createElement(L,null):m.default.createElement("div",{className:T("slice-container")},n.map(function(e){var t=e.name,r=e.id,n=e.artboard_id,a=e.image,i=e.image_set
return m.default.createElement(M,{key:r,src:a,name:t,currentArtboardId:c,id:r,imageSet:i,artboardId:n,requestLayer:o.requestLayer,activeLayer:o.handleActiveLayer,activeLayerId:l})}),m.default.createElement(j,{onClick:this.downloadSlice,isLoading:t,isLogin:s}))}}]),a}(m.PureComponent)
O.propTypes={slicesMap:h.default.array.isRequired,loading:h.default.bool,error:h.default.bool,currentArtboardId:h.default.string,isLogin:h.default.bool,projectCid:h.default.string,projectName:h.default.string,dispatch:h.default.func}
...
var j=function(e){var t=e.onClick,r=e.isLoading,n=e.isLogin?null:I18N.preview.guide_login
return m.default.createElement(y.Tooltip,{content:{click:n},type:"block",position:"top",arrowed:!1,className:T("download"),onClick:t},I18N.preview_panel.download,r?m.default.createElement(N,null):m.default.createElement(b.default,{type:"dora",name:"export",className:T("icon-download")}))}
j.propTypes={onClick:h.default.func,isLoading:h.default.bool,isLogin:h.default.bool}
function I(){return m.default.createElement("div",{className:T("layer-load")},m.default.createElement("span",{className:T("spinner")}))}var N=function(){return m.default.createElement("div",{className:T("download-slice-load")},m.default.createElement(I,null))},R=function(){return m.default.createElement("div",{className:T("slice-load-wrap")},m.default.createElement(I,null))},L=function(){return m.default.createElement("div",{className:T("no-slice")},m.default.createElement("img",{
src:"/images/preview/no-slice@2x.png"}),m.default.createElement("span",null,I18N.preview_panel.no_slice),m.default.createElement("span",null,I18N.preview_panel.slice_in_sketch),m.default.createElement("a",{href:window.MBSketchPluginDownloadURL},m.default.createElement("img",{src:"/images/preview/ic_sketch@2x.png",alt:"sketch"}),I18N.preview_panel.download_sketch))},D=function(){var r=(0,i.default)(c.default.mark(function e(t,r){var n,a,i,o,l
return c.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:n=!0,i=1
case 2:if(!n){e.next=22
break}if(P)return e.abrupt("return")
e.next=5
break
case 5:return e.next=7,(0,_.fetchSliceZip)(t)
case 7:if(o=e.sent,l=o.url,"ok"!==o.status){e.next=15
break}n=!1,a=l,e.next=17
break
...
case 20:e.next=2
break
case 22:return(0,k.downloadWithATag)({url:"/".concat(a),name:r,type:"zip"}),e.abrupt("return",!0)
case 24:case"end":return e.stop()}},e)}))
return function(e,t){return r.apply(this,arguments)}}(),A=(0,v.connect)(function(e){var t=e.model,r=t.current.projectCid,n=t.user,a=e.container.slices,i=a.slices,o=a.loading,l=a.error,c=(0,x.getCurrentScreen)(e)
return{slicesMap:i,loading:o,error:l,isLogin:!!n.id,projectCid:r,currentArtboardId:c.artboard_id}})(O)
t.SliceContainer=A},gX9a:function(e,t,r){e.exports={"play-setting-menu":"_1FA8P7EgiQtr3ukFbj9cuo"}},gXld:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var Ie=n(r("lSNA")),a=n(r("17x9")),Ne=n(r("q1tI")),Re=r("qOCw"),Le=r("Ro3d"),De=r("PqLM"),Ae=r("RUem")
...
x=t.bg_colors,T=void 0===x?[]:x,P=t.borders,O=void 0===P?[]:P,M=t.i,j=t.display_name,I=t.padding,N=void 0===I?0:I,R=t.hiddSpacing,L=void 0!==R&&R,D=t.text_styles,A=void 0===D?[]:D,B=t.alignment,F=t.vertical_alignment,q=t.image,U=t.text,W=t.letter_spacing,H=t.image_set_zip,Y=t.shadows,z=void 0===Y?[]:Y,X=t.inner_shadows,V=void 0===X?[]:X,J=t.rotation,G=t.textShadows,K=void 0===G?[]:G,Z=t.image_set,Q=void 0===Z?[]:Z,$=t.name,ee=0<O.length,te=0<T.length,re=!!q,ne=0<A.length&&U&&(0,Re.getTextContent)(t).length,
...
if("line"===$){var ce=(0,De.getLineGeneralInfo)(t,!0),se=ce.length,ue=ce.thickness,de=ce.angle
le.width=se,le.height=ue,le.rotation=de}var fe=(0,Re.getBaseAttributes)(le),pe=fe.adapterTop,he=fe.adapterLeft,me=fe.adapterWidth,ve=fe.adapterHeight,ge=fe.radius,ye=fe.opacity,be=fe.rotate,Se={lineHeight:_,letterSpacing:W,unit:r,ratio:n},we=(0,Re.getTextAttributes)(Se),Ee=we.lineHeight,Ce=we.letterSpacing,ke="number"==typeof M?M?"italic":"normal":void 0,_e={textStyles:A,background:T,borders:O,shadows:z,innerShadows:V,colorUnit:v,ratio:n,unit:r},xe=(0,Re.getCodeAttributes)(_e),Te=t.o&&100!=t.o?t.o/100:null,
Pe=(0,Le.transfromProptype)({attr:function(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{}
e%2?Be(r,!0).forEach(function(e){(0,Ie.default)(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):Be(r).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:B,opacity:Te,borderRadius:ge},xe),language:m,unit:r}),Oe=re?"ImageView":ne?"TextView":"View",Me="screen"===t.type||t.kind?t.name:j,je="line"===t.name
return a?Ne.default.createElement(Ne.default.Fragment,null,Ne.default.createElement(Ae.LayerName,{title:I18N.preview_panel.screen_name,value:Me}),Ne.default.createElement(Ae.GlobalAttributes,{adapterWidth:me,adapterHeight:ve,documentColor:f,globalText:u,globalColor:c,screenColor:h,userPickColor:o,colorUnit:v,dispatch:g})):Ne.default.createElement("div",null,Ne.default.createElement(Ae.LayerName,{value:Me}),Ne.default.createElement(Ae.BasicAttributes,{adapterTop:pe,adapterLeft:he,adapterWidth:me,
adapterHeight:ve,rotate:be,radius:ge,opacity:ye,unit:r,colorUnit:v}),ne&&Ne.default.createElement(Ae.TextLayerInfo,{textStyles:A,alignment:B,vertical_alignment:F,lineHeight:Ee,letterSpacing:Ce,ratio:n,unit:r,o:t.o,padding:N,fontStyle:ke,colorUnit:v,hiddSpacing:L,text:(0,Re.getTextContent)(t)}),te&&Ne.default.createElement(Ae.Fills,{backgroundColorSort:T,colorUnit:v}),ee&&Ne.default.createElement(Ae.BorderInfo,{isStroke:je,borderSort:O,ratio:n,unit:r,colorUnit:v}),ae&&Ne.default.createElement(Ae.Shadows,{
shadows:z,textShadows:K,colorUnit:v,unit:r,ratio:n}),ie&&Ne.default.createElement(Ae.Shadows,{shadows:V,colorUnit:v,unit:r,ratio:n,isInnerShaow:!0}),oe&&Ne.default.createElement(Ae.ImageInfo,{imageSetZip:H,name:t.display_name,imageSet:Q}),Ne.default.createElement(Ae.CodeBox,{code:Pe,whichAndView:Oe,language:m,text:(0,Re.getTextContent)(t)||""}))}i.propTypes={userPickColor:a.default.array,screenColor:a.default.array,documentColor:a.default.array,globalText:a.default.array,globalColor:a.default.array,
...
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=p,t.watchFetchSlices=h,t.fetchSliceData=m
var a=n(r("lSNA")),o=n(r("o0o1")),l=r("oZtI"),c=n(r("Nu6V"))
function i(t,e){var r=Object.keys(t)
if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t)
e&&(n=n.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),r.push.apply(r,n)}return r}function s(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{}
e%2?i(r,!0).forEach(function(e){(0,a.default)(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):i(r).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}var u=o.default.mark(p),d=o.default.mark(h),f=o.default.mark(m)
function p(){return o.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,l.all)([h()])
case 2:case"end":return e.stop()}},u)}function h(){return o.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,l.takeEvery)("reducer:slice:init",m)
case 2:case"end":return e.stop()}},d)}function m(e){var t,r,n,a,i
return o.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,l.select)()
case 2:if(t=e.sent,r=t.model.current.projectCid,e.prev=4,r)return e.next=8,(0,l.call)(c.default,r)
e.next=14
break
case 8:n=e.sent,a=n.slices,i=a.filter(v),n.slices=i,e.next=15
break
...
case 15:return e.next=17,(0,l.put)({type:"reducer:slice:success",payload:s({},n)})
case 17:e.next=24
break
case 19:return e.prev=19,e.t0=e.catch(4),console.log(e.t0.stack),e.next=24,(0,l.put)({type:"reducer:slice:fail"})
case 24:case"end":return e.stop()}},f,null,[[4,19]])}var v=function(e){var t=e.width,r=void 0===t?1:t,n=e.height
...
t.default=u},jbqJ:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=n(r("pVnL")),o=n(r("QILm")),l=n(r("lwsE")),c=n(r("W8MJ")),s=n(r("a1gu")),u=n(r("Nsbk")),d=n(r("PJYZ")),f=n(r("7W2i")),p=n(r("lSNA")),h=n(r("q1tI")),i=n(r("17x9")),m=r("6XO9"),v=function(e){function i(){var e,t;(0,l.default)(this,i)
for(var r=arguments.length,n=new Array(r),a=0;a<r;a++)n[a]=arguments[a]
return t=(0,s.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(t),"handleChange",function(e){return t.props.onConfirm(e,t.props.attr)}),t}return(0,f.default)(i,e),(0,c.default)(i,[{key:"render",value:function(){var e=this.props,t=(e.attr,e.onConfirm,e.precision),r=e.dontSelectOnFocus,n=(0,o.default)(e,["attr","onConfirm","precision","dontSelectOnFocus"])
return h.default.createElement(m.PanelInputNumber,(0,a.default)({precision:t,dontSelectOnFocus:r,onConfirm:this.handleChange},n))}}]),i}(h.default.PureComponent);(t.default=v).propTypes={precision:i.default.number,dontSelectOnFocus:i.default.bool,value:i.default.oneOfType([i.default.string,i.default.number]),attr:i.default.oneOfType([i.default.string,i.default.array]),onConfirm:i.default.func},v.defaultProps={precision:0,dontSelectOnFocus:!0}},jeLk:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=v,(0,f.default)(v,"propTypes",{className:h.default.string,menuClassName:h.default.string})},m9na:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.CheckboxGroup=t.RadioGroup=t.CheckerLabel=void 0
var l=a(r("PJYZ")),c=a(r("lwsE")),o=a(r("W8MJ")),s=a(r("a1gu")),u=a(r("Nsbk")),d=a(r("7W2i")),f=a(r("lSNA")),p=n(r("q1tI")),i=a(r("17x9"))
r("I19b")
var h=function(e){function t(){return(0,c.default)(this,t),(0,s.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=this.props,t=e.type,r=e.className,n=e.isChecked,a=e.isDisabled,i=e.onClick,o=e.children
return p.default.createElement("label",{className:"\n        ".concat(t,"-label\n        ").concat(n?"is-checked":"","\n        ").concat(a?"is-disabled":"","\n        ").concat(r,"\n        ")},p.default.createElement("button",{className:"checker",onClick:i,disabled:a}),o)}}]),t}(p.PureComponent)
t.CheckerLabel=h,(0,f.default)(h,"propTypes",{type:i.default.oneOf(["radio","check"]).isRequired,className:i.default.string,isDisabled:i.default.bool,isChecked:i.default.bool,onClick:i.default.func,children:i.default.any}),(0,f.default)(h,"defaultProps",{className:""})
var m=function(e){function i(){var e,r;(0,c.default)(this,i)
for(var t=arguments.length,n=new Array(t),a=0;a<t;a++)n[a]=arguments[a]
return r=(0,s.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,f.default)((0,l.default)(r),"createOnChangeHandler",function(e,t){return function(){return r.props.onChange(e,t)}}),r}return(0,d.default)(i,e),(0,o.default)(i,[{key:"render",value:function(){var r=this,e=this.props,t=e.className,n=e.optionList,a=e.currentOptionIdx,i=e.isDisabled
return p.default.createElement("span",{className:"radio-group ".concat(t," ").concat(i?"is-disabled":"")},n.map(function(e,t){return e&&p.default.createElement(h,{key:t,type:"radio",isChecked:t===a,isDisabled:i||e.isDisabled,onClick:!(i||e.isDisabled)&&r.createOnChangeHandler(e.val,t)},e.name)}))}}]),i}(p.PureComponent)
t.RadioGroup=m,(0,f.default)(m,"propTypes",{className:i.default.string,onChange:i.default.func,optionList:i.default.array,currentOptionIdx:i.default.number,isDisabled:i.default.bool}),(0,f.default)(m,"defaultProps",{className:""})
var v=function(e){function a(){var e,o;(0,c.default)(this,a)
for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n]
return o=(0,s.default)(this,(e=(0,u.default)(a)).call.apply(e,[this].concat(r))),(0,f.default)((0,l.default)(o),"createOnChangeHandler",function(i){return function(){var e=o.props,t=e.onChange,r=e.currentOptionIdxList,n=new Set(r),a=n.has(i)?"delete":"add"
n[a](i),t(n)}}),o}return(0,d.default)(a,e),(0,o.default)(a,[{key:"render",value:function(){var r=this,e=this.props,t=e.className,n=e.optionList,a=e.currentOptionIdxList,i=e.isDisabled,o=new Set(a)
return p.default.createElement("span",{className:"checkbox-group ".concat(t," ").concat(i?"is-disabled":"")},n.map(function(e,t){return e&&p.default.createElement(h,{key:t,type:"check",onClick:r.createOnChangeHandler(t),isDisabled:i||e.isDisabled,isChecked:o.has(t)},e.name)}))}}]),a}(p.PureComponent)
t.CheckboxGroup=v,(0,f.default)(v,"propTypes",{className:i.default.string,onChange:i.default.func,optionList:i.default.array,currentOptionIdxList:i.default.oneOfType([i.default.instanceOf(Set),i.default.array]),isDisabled:i.default.bool}),(0,f.default)(v,"defaultProps",{className:"",currentOptionIdxList:new Set})},"mC/1":function(e,t,r){"use strict"
var n=r("TqRt")
...
default:return"px"}}},qY2g:function(e,t,r){},qYFl:function(e,t,r){"use strict"
var n=r("TqRt")
...
t.StyledPreviewPanel=a},r1rb:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=n(r("pVnL")),i=n(r("lwsE")),o=n(r("W8MJ")),l=n(r("a1gu")),c=n(r("Nsbk")),s=n(r("7W2i")),u=n(r("q1tI")),d=r("6XO9"),f=function(e){function t(){return(0,i.default)(this,t),(0,l.default)(this,(0,c.default)(t).apply(this,arguments))}return(0,s.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=(0,a.default)({},this.props)
return u.default.createElement(d.Tooltip,e)}}]),t}(u.default.PureComponent)
t.default=f},rESR:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
text:i.default.string,o:i.default.number,padding:i.default.number,colorUnit:i.default.string}},wYtL:function(e,t,r){"use strict"
var n=r("284h"),a=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"FormEntry",{enumerable:!0,get:function(){return s.FormEntry}}),Object.defineProperty(t,"FormLabel",{enumerable:!0,get:function(){return s.FormLabel}}),Object.defineProperty(t,"CheckerLabel",{enumerable:!0,get:function(){return u.CheckerLabel}}),Object.defineProperty(t,"RadioGroup",{enumerable:!0,get:function(){return u.RadioGroup}}),Object.defineProperty(t,"CheckboxGroup",{enumerable:!0,get:function(){return u.CheckboxGroup}}),
t.TooltipGlobalStyle=t.Select=t.Check=t.InputNumber=t.Tooltip=t.Input=void 0
var i=a(r("VkAN")),o=r("00a+"),l=r("6XO9"),c=n(r("vOnD")),s=r("TT1N"),u=r("m9na"),d=a(r("Rm7n")),f=a(r("MzIM")),p=a(r("jbqJ")),h=a(r("r1rb"))
function m(){var e=(0,i.default)(["\n  .is-ToolTip-Close {\n    display: none;\n  }\n\n  .project-name-tips {\n    .content {\n      word-wrap: break-word;\n      max-height: 5em;\n      overflow: hidden;\n    }\n  }\n\n  .TipBase {\n    .is-open {\n      .content {\n        background: rgb(31, 41, 46);\n      }\n    }\n  }\n\n  .tooltip-arrow {\n    display: none;\n  }\n\n  .tooltip {\n    .tooltip-inner {\n      background: #1f292e;\n    }\n  }\n"])
return m=function(){return e},e}var v=(0,o.withTheme)(l.Input)
t.Input=v
var g=(0,o.withTheme)(d.default),y=(0,o.withTheme)(f.default),b=(0,o.withTheme)(p.default),S=(0,o.withTooltip)(h.default)
t.Tooltip=S
var w=(0,c.createGlobalStyle)(m())
t.TooltipGlobalStyle=w
var E=(0,c.default)(b).withConfig({displayName:"form__InputNumber",componentId:"sc-1t7hcl8-0"})(["&.is-valid:not(.unstyled){.title{color:#8d9ea7;}input{color:#415058;background-color:",";border:1px solid ",";}}&.is-valid.is-disabled{.title{opacity:1;color:#e8e8e8;}input{color:#c8cdd0;opacity:1;background-color:",";border:1px solid ",";}}"],function(e){return e.theme.draggablePanel.NumberInput.bg},function(e){return e.theme.draggablePanel.NumberInput.border_color},function(e){
...
t.InputNumber=E
var C=(0,c.default)(g).withConfig({displayName:"form__Check",componentId:"sc-1t7hcl8-1"})(["&.small.is-checked{.Check-state{background-color:#fff;border-color:",";color:#ff6161;}}"],function(e){return e.theme.draggablePanel.CheckBorder.border_color})
t.Check=C
var k=(0,c.default)(y).withConfig({displayName:"form__Select",componentId:"sc-1t7hcl8-2"})(["&.small:not(.unstyled){background-color:",";border:1px solid ",";}"],function(e){return e.theme.draggablePanel.Select.bg},function(e){return e.theme.draggablePanel.Select.border_color})
t.Select=k},wfO3:function(e,t,r){},wmEP:function(e,t,r){"use strict"
var n=r("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var i=a.layers
return e?(0,m.default)(i,function(e){return e.id===n}):C({},i[0])})},zy85:function(e,t,r){e.exports={"runner-control-panel":"_1WWZX-XsmLEpK_NTDJ6--O"}}},[[7,1,0]]])

//# sourceMappingURL=preview-51673e7a83f5894e232c.js.map